...
const EyeOpen = (props) => {
    ...
    return (
        <div className="eyeicon" title="Show password" onClick={(e) => props.setViewPassword()}>
            <svg width="22px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
