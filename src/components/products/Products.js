...
const Products = (props) => {
    ...
    return (
        <div className="products">
            ...
            <section className="pt-32 pb-40 bg-secondary-dark">
                <div className="container mx-auto" >
                    ...
                    <div className="p-4 mb-8 rounded-3 bg-secondary">
                        <div className="pt-12 pb-14 px-6 px-sm-16 px-md-24 rounded-2 new-primary">
                            <div className="row align-items-center">
                                ...
                                <div className="col-12 col-md-4 col-xl-3 ms-auto">
                                    <div className="text-center">
                                        ...
                                        <Link className="btn btn-outline-light" to="/purchase">
                                            Buy now
                                        </Link>
                                    </div>
                                </div>
            ...
            >
                <img
                    className="position-absolute bottom-0 end-0 mb-n12 col-12 col-md-6 col-xxl-auto img-fluid"
                ...
                />
                <img
                    className="position-absolute top-0 start-0 col-12 col-md-6 col-xxl-auto translate-middle-x img-fluid"
                    src="zospace-assets/lines/circle.svg"
                    alt=""
