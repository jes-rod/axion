...
const Home = (props) => {
    ...
    return (
        <div className="home">
            <section className="position-relative overflow-hidden bg-secondary-dark">
                <img
                    className="position-absolute top-0 start-0 w-100 h-100 img-fluid"
                    style={{ objectFit: "cover" }}
                    src="images/pngtree-smartphone-with-a-dark-screen-and-a-futuristic-interface-picture-image-2683165.jpg"
                    alt=""
                />
                <Navbar />    {/* Navbar component imported  */}   
                <div className="container position-relative">
                    <div className="row position-relative pt-32">
                        <div className="col-lg-6 pb-40 pb-md-52 col-12">
                            <h1 className="mw-lg mw-lg-xl mt-6 mb-24 text-light">
                                <span >A </span>
                            ...
                            <div className="d-sm-flex align-items-center">
                                <Link className="btn mb-14 mb-sm-0 me-14 btn-dark" to="/products">
                                    Begin your journey
                                </Link>
                            </div>
                        </div>
            ...
            <section
                id="specifications"
                className="position-relative bg-secondary-dark py-12 overflow-hidden"
            >
                
                <div className="container position-relative">
                    <div className="row mb-n10 mx-md-n10">
                        <div className="col-12 col-md-6 col-lg-4 mb-20 px-md-10">
                            <div className="pt-16 pb-20 px-8 px-sm-16 rounded bg-secondary">
                                <span
                                ...
                                <h4 className="mb-6 text-white">CPU</h4>
                                <p className="text-secondary-light mb-0" >
                                    Our devices are equipped with the latest Snapdragon 8 Gen 1 and 2
                                                            ...
                                                            >
                                                                <div className="ULSxyf">
                                                                    <div className="MjjYud">
                                                                        ...
                                                                        >
                                                                            <div id="tw-main" data-hveid="CAkQAQ">
                                                                                <div
                                                                                    className="tw-bil-e"
                                                                                    data-cp={1}
                                                                                    data-ddp="true"
                        ...
                        <div className="col-12 col-md-6 col-lg-4 mb-20 px-md-10">
                            <div className="pt-16 pb-20 px-8 px-sm-16 rounded bg-secondary">
                                ...
                                <h4 className="mb-6 text-white">Security measures</h4>
                                <p className="text-secondary-light mb-0" >
                                    Privacy and safety guarantees for all your personal data.
                                    <br />
                                </p>
                            </div>
                        </div>
